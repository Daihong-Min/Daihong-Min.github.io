...
\vspace{-1em}
\begin{itemize}[leftmargin=*]
    \plainitem{Financial Economics (ECN 134), Money, Banks, \& Financial Institutions (ECN 135), Public Finance (ECN 131), Intermediate Macro Theory (ECN 101), Intermediate Micro Theory (ECN 100), The Principle of Microeconomics (ECN 1A), The Principle of Macroeconomics (ECN 1B)}
\end{itemize}
\vspace{1em}
