% Edit this CV in Overleaf; publish via Integrations > GitHub.
...
\begin{itemize}[leftmargin=*]
    ...
    \plainitem{``Which Margin Moves? Promotional Slack and the Pass-Through of a Sugar-Sweetened Beverage Tax" (with \href{https://kiesel.ucdavis.edu/}{Kristin Kiesel} and Yijoong Won)}
\end{itemize}
